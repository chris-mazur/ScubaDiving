...
public class ScubaDiving extends StateBasedGame {
	...
	// Initialize game states (calls init method of each gamestate, and set's the
	// state ID)
	@Override
	public void initStatesList(GameContainer gc) throws SlickException {
		/*
		 * The first state added will be the one that is loaded first, when the
		 * application is launched. After, other states are add.
		 */
	...
	public static void main(String[] args) {
		try {
			...
			/*
			 * calling super as parameter of AppGameContainer and pass string gamename}
			 */
